class EventAttendingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_attending.save
        format.html { redirect_to event_attending_url(@event_attending), notice: "Event attending was successfully created." }
  ...
  def update
    respond_to do |format|
      if @event_attending.update(event_attending_params)
        format.html { redirect_to event_attending_url(@event_attending), notice: "Event attending was successfully updated." }
  ...
  private
    ...
    def event_attending_params
      params.require(:event_attending).permit(:attended_event_id, :attending_user_id)
    end
end
